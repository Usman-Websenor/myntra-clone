            ...
            <div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
                <div class="col-lg-4 logo">
                    <a href="index.php" class="text-decoration-none">
                        {{-- text-uppercase : Bootstrap Class For All Caps. --}}
                        <span class="h1  text-primary bg-dark px-2">Ooshi</span>
                        <span class="h1  text-dark bg-primary  ml-n1">Wooshi</span>
                    </a>
                </div>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <picture>
                            ...
                            <img
                                src="{{ asset('front-assets/images/carousel-1.jpg') }}"
                                alt="" />
                        </picture>
                ...
                <div class="row">
                    <div class="col-12 mt-3">
                        <div class="copy-right text-center">
                            <p>© Copyright 2024 OoshiWooshi. All Rights Reserved</p>
                        </div>
                    </div>
                </div>
            </div>
